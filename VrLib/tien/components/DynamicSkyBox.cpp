...
void vrlib::tien::components::DynamicSkyBox::initialize()
{
...
void vrlib::tien::components::DynamicSkyBox::render(const glm::mat4 & projectionMatrix, const glm::mat4 & modelviewMatrix)
{
	glDepthMask(GL_TRUE);
