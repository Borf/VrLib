	...
	namespace gui
	{
		namespace components
		{
			...
			void Image::draw(const glm::mat4 &parentMatrix)
			{
				...
				setP3(v, glm::vec3(0, 0, 0));				setT2(v, glm::vec2(0, 0));			verts.push_back(v);
				setP3(v, glm::vec3(size.x, 0, 0));			setT2(v, glm::vec2(1, 0));			verts.push_back(v);
				setP3(v, glm::vec3(size.x, size.y, 0));		setT2(v, glm::vec2(1, 1));			verts.push_back(v);

				setP3(v, glm::vec3(0, 0, 0));				setT2(v, glm::vec2(0, 0));			verts.push_back(v);
				setP3(v, glm::vec3(size.x, size.y, 0));		setT2(v, glm::vec2(1, 1));			verts.push_back(v);
				setP3(v, glm::vec3(0, size.y, 0));			setT2(v, glm::vec2(0, 1));			verts.push_back(v);
				glBindVertexArray(0);
